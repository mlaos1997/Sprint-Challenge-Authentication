...
- To allow servers to store information about the client. That information can then be used for a variety of purposes.

2. What does bcrypt do to help us store passwords in a secure manner.

- The brcyptjs module comes with a password hashing function, and implements salting both manual and automatically.

3. What does bcrypt do to slow down attackers?

- Adds time to security algorithm to produce Key Derivation Function

4. What are the three parts of the JSON Web Token?

- Header contains the algorithm with the token type. 
- Payload includes information or any other data stored in the token.
